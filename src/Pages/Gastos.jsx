...
//       where("fecha", "<=", Timestamp.fromDate(ultimoDia))
//     );
...
//     try {
//       if (editId) {
//         await updateDoc(doc(db, "gastos", editId), data);
//       } else {
...
//     setFormData({ concepto: gasto.concepto, monto: gasto.monto });
//     setEditId(gasto.id);
//     setShowModal(true);
//   };
...
//   return (
//     <div className="p-4">
//       <h2 className="text-2xl font-bold mb-4 text-center">Gastos del mes</h2>
...
//                     </td>
//                     <td className="p-2 border">{gasto.concepto}</td>
//                     <td className="p-2 border">{formatPrecio(gasto.monto)}</td>
//                     <td className="p-2 border text-center space-x-2">
//                       <button
//                         onClick={() => handleEditarGasto(gasto)}
//                         className="bg-none text-blue-500 px-2 py-1 rounded"
//                       >
//                         Editar
//                       </button>
//                       <button
//                         onClick={() => handleEliminarGasto(gasto.id)}
//                         className="bg-none text-red-500 px-2 py-1 rounded "
//                       >
//                         Eliminar
//                       </button>
//                     </td>
